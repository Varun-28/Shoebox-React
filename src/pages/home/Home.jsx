    ...
    <div className='home-content'>
      <section className="hero">
          <div className="hero-content flex flex-col justify-center p-4">
              ...
              <Link to="/product"><button className="btn btn-primary btn-hero">Shop Now</button></Link>
          </div>
          <div className="hero-img">
              <img className='mx-auto w-80p' loading='eager' src={heroImg} alt="hero" />
          </div>
      </section>
              ...
              <div className="gender-cards flex flex-wrap items-center justify-evenly gap-4 p-8">
                {
                  ...
                  <CategoryCards key={id} 
                  id={id} categoryName={categoryName} categoryImage={categoryImage} />)
                }
              </div>
      </section>
    </div>
