            ...
            <div key={item._id} className="card card-vertical dismiss-card">
              <div className="card-head">
                  ...
                  <div className="card-texts">
                      ...
                      <p className="card-text"><span className="price-now text-md">
                      Rs. {item.price}</span></p>
                  </div>
              </div>
              <div className="card-buttons">
                  <button className="card-btn-primary">Add to cart</button>
              </div>
              <button className="card-exit-btn"
                onClick={() => wishlistDispatch({type:"REMOVE-FROM-WISHLIST", 
                payload: item._id})}>
