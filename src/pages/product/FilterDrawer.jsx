  ...
  return (
    <section style={{display: (width <= 800 && drawerVisibility)  ? 'none' : 'block'}} className="filter-drawer p-4">
        ...
        <div className='filter price-range'>
            <h4>Price Range (0-2K)</h4>
            <input type="range" list="price-list" min="0" max="2000" step="250" value={state.priceRange}
            onChange={(e) => dispatch({type:"PRICE-RANGE", payload: e.target.value})}
            />
        ...
        <div className="filter category">
            ...
            <ul>
                ...
                <input type="checkbox" value="casual-m" id="casual-m" checked={state["categories"].includes("casual-m")}
                    onChange={(e) => dispatch({type:"CATEGORY", payload: e.target.value})}
                />Casual</label>
                </li>
                <li>
                <label htmlFor="formal-m">
                <input type="checkbox" value="formal-m" id="formal-m" checked={state["categories"].includes("formal-m")} 
                onChange={(e) => dispatch({type:"CATEGORY", payload: e.target.value})}
                />Formal</label>
                </li>
                <li>
                <label htmlFor="sport-m">
                <input type="checkbox" value="sport-m" id="sport-m" checked={state["categories"].includes("sport-m")}
                onChange={(e) => dispatch({type:"CATEGORY", payload: e.target.value})}   
                />Sport</label>
                </li>
            </ul>
            ...
            <ul>
                ...
                <input type="checkbox" value="casual-f" id="casual-f" checked={state["categories"].includes("casual-f")}
                onChange={(e) => dispatch({type:"CATEGORY", payload: e.target.value})}
                />Casual</label>
                </li>
                <li>
                <label htmlFor="boot-f">
                <input type="checkbox" value="boot-f" id="boot-f" checked={state["categories"].includes("boot-f")}
                onChange={(e) => dispatch({type:"CATEGORY", payload: e.target.value})}
                />Boot</label>
                </li>
            </ul>
        ...
        <div className="filter rating">
            ...
            />4 star or above</label>
            <label htmlFor="three">
            <input type="radio" name="rating" value="3" id="three" 
            checked={state['rating'] === '3'} 
            onChange={(e) => dispatch({type:"RATING", payload: e.target.value})}    
            />3 star or above</label>
            <label htmlFor="two">
            <input type="radio" name="rating" value="2" id="two" 
            checked={state['rating'] === '2'} 
            onChange={(e) => dispatch({type:"RATING", payload: e.target.value})}    
            />2 star or above</label>
            <label htmlFor="one">
            <input type="radio" name="rating" value="1" id="one" 
            checked={state['rating'] === '1'} 
            onChange={(e) => dispatch({type:"RATING", payload: e.target.value})}    
            />1 star or above</label>   
        </div>
        <span className="hr-gray-line"></span>
        <div className="filter sort-by">
            <h4>Sort by</h4>
            <label htmlFor="low">
            <input type="radio" name="price" value="l" id="low"  checked={state.sorting === "low"}
            onChange={() => dispatch({type:"LOW-TO-HIGH", payload: "low"})}
            />Price - low to high</label>
            <label htmlFor="high">
            <input type="radio" name="price" value="h" id="high" checked={state.sorting === "high"}
        ...
        <div className="filter stock-delivery">
            ...
            <ul>
                ...
                <input type="checkbox" value="inStock" id="inStock" checked={state.inStock === true} 
                onChange={() => dispatch({type:"IN-STOCK"})}
                />In Stock Only</label>
                </li>
                <li>
                <label htmlFor="isFastDelivery">
                <input type="checkbox" value="isFastDelivery" id="isFastDelivery" checked={state.isFastDelivery === true}
