...
import { sortFun, fastDeliveryFun, ratingFun, categoryFun, stockFun, priceRangeFun} from './filterFunctions';

const ProductContext = createContext();

const filterFunction = (state, action) => {
    switch (action.type) {
        case "LOW-TO-HIGH": return {...state, sorting: action.payload};
        case "HIGH-TO-LOW": return {...state, sorting: action.payload};
        case "IN-STOCK": return {...state, inStock: !state.inStock};
        case "IS-FAST-DELIVERY": return {...state, isFastDelivery: !state.isFastDelivery};
        case "RATING": return {...state, rating: action.payload};
        case "PRICE-RANGE": return {...state, priceRange: action.payload};
        ...
        case "CLEAR": return initialFilter;
